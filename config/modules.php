...
return [
    ...
    */
    'stubs' => [
        'enabled' => false,
        'path' => base_path('Modules/Main/app/Console/stubs/nwidart-stubs'),
        'files' => [
            'routes/web' => 'routes/web.php',
            'routes/api' => 'routes/api.php',
            'routes/adminWeb' => 'routes/adminWeb.php',
            'routes/adminApi' => 'routes/adminApi.php',
        ...
        'replacements' => [
            ...
            'routes/adminWeb' => ['LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE', 'CONTROLLER_NAMESPACE'],
            'routes/adminApi' => ['LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE', 'CONTROLLER_NAMESPACE'],
    ...
    'paths' => [
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Path to folder for vue files in module with access to the inertiaJs.
        |
        */
        'source' => 'resources/assets/js/Pages',
    ...
    */
    'composer' => [
        ...
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Bihacsy László'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'bihacsylaszlo@gmail.com'),
        ],
